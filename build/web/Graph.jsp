<%@page import="com.apps.graph.ComparisionGraph1"%>
<%@page import="com.apps.graph.ComparisionGraph"%>
...
<div class="wrapper row3">
  <div class="rnd">
    <div id="container" class="clear">
     ...
     <%                                        
        ComparisionGraph  objBarChart = new ComparisionGraph();                                                                                                                                            
     %>  

    <table border="0px" align="center">
        <tr>                                                         
            <td><img src="${pageContext.request.contextPath}/images/ComparisionGraph.png" alt="Graph"/></td>                                                       
        </tr>
    </table>
    ...
    <h1>Graph 2:</h1>
     ...
     <%                                        
        ComparisionGraph1  objBarChart1 = new ComparisionGraph1();                                                                                                                                            
     %>  

    <table border="0px" align="center">
        <tr>                                                         
            <td><img src="${pageContext.request.contextPath}/images/ComparisionGraph1.png" alt="Graph"/></td>                                                       
        </tr>
    </table>
