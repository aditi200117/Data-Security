...
public class ComparisionGraph1
{
    public ComparisionGraph1()
    {     
        ...
        try
        {
              ...
              JFreeChart barChart = ChartFactory.createBarChart(
                 "Comparision Of File Count Vs Decryption Time", 
                 "Decryption Time[Milliseconds]", "File Count", 
                 dataset,PlotOrientation.VERTICAL, 
                 true, true, false);

              int width = 640; /* Width of the image */
              int height = 480; /* Height of the image */ 
              File BarChart = new File( "E://NetBeansProjects//DataSecurity//build//web//images//ComparisionGraph1.png" ); 
