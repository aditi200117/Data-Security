...
public class ComparisionGraph2
{
    public ComparisionGraph2()
    {     
        ...
        try
        {
              ...
              JFreeChart barChart = ChartFactory.createBarChart(
                 ...
                 "File Count", "Decryption Time[Milliseconds]", 
                 dataset,PlotOrientation.VERTICAL, 
                 true, true, false);

              int width = 640; /* Width of the image */
              int height = 480; /* Height of the image */ 
              File BarChart = new File( "E://NetBeansProjects//DataSecurity//build//web//images//ComparisionGraph2.png" ); 
