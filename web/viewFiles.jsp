        ...
        <div class="wrapper row3">
            <div class="rnd">
                <div id="container" class="clear">
                    <!-- ####################################################################################################### -->
                    <h1>View List Of Uploaded Files</h1>
                     ...
                     <%
                        ...
                        try
                        {
                                int g = 1;
                                 ...
                                 String sql = "select u.FileName, u.Filesize, u.UploadId "
                                         + " from upload as u"                                       
                                         + " left join userdetails as p on p.PerId  = u.PerId "
                                         + " where p.username = '" + session.getAttribute("x") + "' ";
                                ...
                                while(rs.next())
                                {
                                     out.println("<tr>"
                                             ...
                                             + "<td><a href='codefiledownload.jsp?index="+ rs.getInt(3)+"'><img src='images/Download.png'></img></a></td>"                                                                                      
                                             
                                             + "<td><a href='codeDelete.jsp?index="+ rs.getInt(3)+"'><img src='images/Delete.png'></img></a></td>"
                                ...
                                if(g == 1)
                                {
                                     out.println("<tr>"
                                             + "<td>&nbsp;</td>"
                                             + "<td>&nbsp;</td>"                                                                                                                          
                                             + "<td><font style='color:red;'>No pending request found!<font></td>"
                                             + "<td>&nbsp;</td>"
                                             + "<td>&nbsp;</td>");
                                 }
